...
/**
 * Servlet implementation class PriceRecommend
 */
@WebServlet("/PriceRecommend")
public class PriceRecommend extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(p!=null){
			RequestDispatcher rd=request.getRequestDispatcher("recommendprice-friend.jsp");
