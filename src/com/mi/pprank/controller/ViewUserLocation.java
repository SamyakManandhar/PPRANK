...
/**
 * Servlet implementation class ViewUserLocation
 */
@WebServlet("/ViewUserLocation")
public class ViewUserLocation extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		userDao = new UserDao();
		u1 = userDao.Viewalluserlocation();
		if(u1.isEmpty()){
			RequestDispatcher rd = request.getRequestDispatcher("alluser-location.jsp");
