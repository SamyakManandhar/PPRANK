...
/**
 * Servlet implementation class ProductRecommendation
 */
@WebServlet("/ProductRecommendation")
public class ProductRecommendation extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(p!=null){
			RequestDispatcher rd=request.getRequestDispatcher("recommend-friend.jsp");
