...
/**
 * Servlet implementation class ProductRecommend
 */
@WebServlet("/ProductRecommend")
public class ProductRecommend extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			rs = stmt.executeQuery("SELECT username, auth FROM recommendfriend");
			while (rs.next()) {
