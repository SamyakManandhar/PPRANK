					...
					<div id="user-services" class="text-center">
						...
						<div class="row">
							...
							<div class="col-sm-4 operation-thumbs">
								...
								<h4>
									<a href="ViewProducts"><b>NEWSFEED OF PRODUCTS</b></a>
								</h4>
								<p>All NewsFeed Of Products</p>
							</div>
							<!-- FONT AWESOME ICONS -->
							...
							<div class="col-sm-4 operation-thumbs">
								...
								<h4>
									<a href="ViewFri?username=${username}"><b>FRIENDS</b></a>
								</h4>
								<p>All Friends</p>
							</div>
							<!--div class="col-sm-4 operation-thumbs">
                               ...
                               <div class="col-sm-4 operation-thumbs">
								<span class="glyphicon glyphicon-user logo-small"></span>
								<h4>
									<a href="MyProfile?username=${username}"><b>MY PROFILE</b></a>
								</h4>
								<p>User can view the profile</p>
							</div>
							<div class="col-sm-4 operation-thumbs">
								<span class="glyphicon glyphicon-arrow-right logo-small"></span>
								<h4>
									<a href="ViewSendRequest?username=${username}"><b>SEND REQUEST</b></a>
								</h4>
								<p>User can send the request</p>
							</div>
							<div class="col-sm-4 operation-thumbs">
								<span class="glyphicon glyphicon-tag logo-small"></span>
								<h4>
									<a href="ViewRequest?username=${username}"><b>VIEW REQUEST</b></a>
								</h4>
								<p>User can view the request</p>
							</div>
                       <div class="col-sm-4 operation-thumbs">
								<span class="glyphicon glyphicon-tags logo-small"></span>
								<h4>
									<a href="ViewProductRecommend"><b>RECOMMENDATIONS</b></a>
								</h4>
								<p>User can recommend the product</p>
							</div>
							<div class="col-sm-4 operation-thumbs">
								<span class="glyphicon glyphicon-star logo-small"></span>
								<h4>
									<a href="reviews.jsp"><b>REVIEWS</b></a>
								</h4>
								<p>User can check out the reviews of products</p>
							</div>
							<div class="col-sm-4 operation-thumbs">
								<span class="glyphicon glyphicon-tags logo-small"></span>
								<h4>
									<a href="UserRecommend?username=${username}"><b>VIEW RECOMMENDATIONS</b></a>
								</h4>
								<p>User can view recommendation</p>
							</div>
...
<center><a href="user-signin.jsp" class="btn btn-danger"><span class="glyphicon glyphicon-home">BACK</a></center>
</body>
</html>