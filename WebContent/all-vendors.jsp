...
<!-- START HEADER INCLUDING TITLE -->
	...
	<!-- END HEAD DIV -->
	<!-- START CONTENT -->
	<garima:if test="${not empty vendorList }">
			<br><br><br>
			<h4><center><b>All Userdetails List</center></b></h4>
			<hr>
			
	<garima:forEach items="${vendorList }" var="v">				
		<div class="col-md-4">
								<div class="cart-product-wrapper">
									<div class="cart-product">
										<label>User Name : </label>
										<strong class="h5">${v.username }</strong><br>
										<label>First Name : </label>
										<strong class="h5">${v.firstname }</strong><br>
										<label>Last Name : </label>
										<strong class="h5">${v.lastname }</strong><br>
										<label>Phone_number : </label>
										<strong class="h5">${v.phone_number }</strong><br>
										<label>Email: </label>
										<strong class="h5">${v.email }</strong><br>
										
										<label>Location: </label>
										<strong class="h5">${v.location }</strong><br>
										<label>Password: </label>
										<strong class="h5">${v.password }</strong><br>
