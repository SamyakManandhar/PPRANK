				...
				<div class="col-md-9">
					<div id="user-services" class="text-center">
						...
						<div class="col-sm-4 operation-thumbs">
							...
							<h4>
								<a href="FriendCount"><b>FRIENDREQUEST COUNT</b></a>
							</h4>
							<p>Count of Friends.</p>
						</div>
						
						<div class="col-sm-4 operation-thumbs">
							<span class="glyphicon glyphicon-tasks logo-small"></span>
							<h4>
								<a href="FriendRequestAccept"><b>COMPARISON BETWEEN FRIENDS AND RANDOM USERS</b></a>
							</h4>
							<p>Users accepting friend request and pending friend request..</p>
						</div>
						<div class="col-sm-4 operation-thumbs">
							<span class="glyphicon glyphicon-tasks logo-small"></span>
							<h4>
								<a href="ProductRatingCount"><b>PRODUCT RATING OF DIFFERENT PRODUCTS</b></a>
							</h4>
							<p>Product Rating of Different Products..</p>
						</div>
						<div class="col-sm-4 operation-thumbs">
							<span class="glyphicon glyphicon-list logo-small"></span>
							<h4>
								<a href="ProductRecommend"><b>PRODUCT RECOMMEND CHART</b></a>
							</h4>
							<p>Comparison between recommendation to friends and random people..</p>
						</div>
						<div class="col-sm-4 operation-thumbs">
							<span class="glyphicon glyphicon-list logo-small"></span>
							<h4>
								<a href="HighestRecommendation"><b>HIGHLY RATED PRODUCT BY USERS</b></a>
							</h4>
							<p>Highly Rated Product By Users..</p>
						</div>
						<!--  START VENDORS DIV-->
