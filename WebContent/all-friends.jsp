...
<!-- START HEADER INCLUDING TITLE -->
	...
	<!-- END HEAD DIV -->
	<!-- START CONTENT -->
	<garima:if test="${not empty friendrequestList }">
			<br><br><br>
			<h4><center><b>All FriendRequest List</center></b></h4>
			<hr>
			
	<garima:forEach items="${friendrequestList }" var="f">				
		<div class="col-md-4">
								<div class="cart-product-wrapper">
									<div class="cart-product">
										<label> From User Name : </label>
										<strong class="h5">${f.fromusername }</strong><br>
										<label>User Name : </label>
										<strong class="h5">${f.username }</strong><br>
										<label>Email : </label>
										<strong class="h5">${f.email }</strong><br>
										<label>Phone_number : </label>
										<strong class="h5">${f.phone_number }</strong><br>
										<garima:choose>
								<garima:when test ="${f.auth==0}">
								<label>FriendRequest :<a href="validateuser.jsp?username=${f.username}&name=${f.fromusername}">Waiting</a></label>
								</garima:when>
