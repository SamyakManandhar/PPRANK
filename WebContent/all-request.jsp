...
<!-- START HEADER INCLUDING TITLE -->
	...
	<!-- END HEAD DIV -->
	<!-- START CONTENT -->
	<garima:set value="${friendRequestDetails}" var="friendRequest" />
						<br>
								...
								<div class="cart-product-wrapper">
									<div class="cart-product">
								       ...
								       <label>From Name : </label>
										<strong class="h5">${friendRequest.fromusername }</strong><br>
								
										<label>User Name : </label>
										<strong class="h5">${friendRequest.username }</strong><br>
										<label>Email : </label>
										<strong class="h5">${friendRequest.email }</strong><br>
										<label>Phone Number : </label>
										<strong class="h5">${friendRequest.phone_number }</strong><br>
								<garima:choose>
								<garima:when test ="${friendRequest.auth==0}">
								<label>FriendRequest :<a href="validateuser.jsp?username=${friendRequest.username}&name=${friendRequest.fromusername}">Waiting</a></label>
								</garima:when>
