...
<!-- START HEADER INCLUDING TITLE -->
	...
	<!-- END HEAD DIV -->
	<!-- START CONTENT -->
	<garima:if test="${not empty productList }">
			<br><br><br>
			<h4><center><b>All Productdetails List</center></b></h4>
			<hr>
			
	<garima:forEach items="${productList }" var="p">				
		<div class="col-md-4">
								<div class="cart-product-wrapper">
									<div class="cart-product">
										<label>Product Name : </label>
										<strong class="h5">${p.productname }</strong><br>
										<label>Description : </label>
										<strong class="h5">${p.description }</strong><br>
										<label>Date : </label>
										<strong class="h5">${p.date }</strong><br>
										<label>Category : </label>
										<strong class="h5">${p.category }</strong><br>
										<label>Price : Rs</label>
										<strong class="h5">${p.price }</strong><br>
									...
									<div class="row">
										...
										<div class="col-xs-12 text-center">
											<a href="ProductDetails?productname=${p.productname}"><span class="glyphicon glyphicon-list-alt"></span>View More
											</a>
	...
	<br><br><br><br><br><br><br><br><br><br><br>
		<hr>
		<p>
<center><a href="user.jsp" class="btn btn-danger"><span class="glyphicon glyphicon-home">BACK</a></center><br><br>
<footer class="footer">
	<div class="container">
	<div class="row">
	<div class ="col-md-12">
